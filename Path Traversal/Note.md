...
If there are Images on a website --> Open image in new tab and check for path traversal there because often times images are included using file API.


![[Pasted image 20240226131726.png]]
